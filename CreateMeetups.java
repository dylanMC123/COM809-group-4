...
public class CreateMeetups extends Meetup
{
    ...
    private static Scanner readHelp;
    private static FileReader HelpFileName;
    ...
    protected void userCreatedMeetUps(String titleOutput, String locationOutput, String descriptionOutput, String completionOutput)
    {
        //scanner object
        ...
        System.out.println(descriptionOutput);
    ...
    protected String userSetDate ()
    {
        ...
        do {
            ...
            desiredOutput = fullDate.substring(0, 10);
            yearOutput = fullDate.substring(24, 28);

            if(Integer.parseInt(yearOutput) >= 2023)
            {
                correctYear = true;
            }
            else
        ...
        while (!checkTime)
        {
            ...
            {
                System.out.println("Incorrect Minutes please enter a valid number:");
